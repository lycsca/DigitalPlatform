...
namespace DigitaPlatform.Common.Converter
{
    ...
    public class DeviceItemConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var assembly = Assembly.Load("DigitaPlatform.Components");
            Type t = assembly.GetType("DigitaPlatform.Components." + value.ToString())!;
